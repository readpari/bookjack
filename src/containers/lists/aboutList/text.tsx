export const text = {
  EN: [
    "Bookjack is a unique reading app. He doesn't care if you want to read or not. You will read whatever it takes.",
    "Choose a book. Make a bet that you will have time to read it, for example, in 1 week. If you don't make it, you will lose your money. If you succeed, the money will be returned to you. You won't get any profit, but the victory will pay off the time spent.",    'How Bookjack works. \n Bookjack works on the Near blockchain.It is a simple open source smart contract. A smart contract is a smart wallet that manages its money according to a strictly defined algorithm. It cannot be changed, blocked or hacked.',
  ...
  RU: [
    'Bookjack это уникальное приложение для чтения. \n  Его не интересует, хотите вы читать или не хотите. \n  Вы будете читать, чего бы Вам это не стоило.',
    'Выберите книгу. Сделайте ставку, что успеете прочитать ее, например за 1 неделю. Если не успеете, Вы проиграете свои деньги. Если успеете, деньги вернутся Вам обратно. Прибыли вы не получите, но победа окупит потраченное время.',

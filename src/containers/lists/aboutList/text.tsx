export const text = {
  EN: [
    ...
    "Choose a book. Make a bet that you will have time to read it, for example, in 1 week. If you don't make it, you will lose your money. If you succeed, the money will be returned to you. You won't get any profit, but the victory will pay off the time spent.",
  ...
  RU: [
    ...
    'Как работает Bookjack. \n Bookjack это смарт-контракт на блоечейне Near. Смарт-контракт это умный кошелек с открытым исходным кодом, который распоряжается  своими деньгами, по строго заданному алгоритму. Его невозможно изменить, заблокировать или взломать.',
